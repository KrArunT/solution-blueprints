...
{{- if and .Values.localModelCache.enabled .Values.localModelCache.cacheEnv.enabled }}
- name: HF_HOME
  value: {{ .Values.localModelCache.cacheEnv.hfHome | quote }}
- name: TRANSFORMERS_CACHE
  value: {{ .Values.localModelCache.cacheEnv.transformersCache | quote }}
- name: HF_HUB_CACHE
  value: {{ .Values.localModelCache.cacheEnv.hfHubCache | quote }}
{{- end }}
...
- mountPath: /dev/shm
  name: dshm
{{- if and .Values.localModelCache.enabled .Values.localModelCache.hostPath }}
- mountPath: {{ .Values.localModelCache.mountPath }}
  name: local-model-cache
  readOnly: {{ .Values.localModelCache.readOnly }}
{{- end }}
...
- name: local-model-cache
  hostPath:
    path: {{ .Values.localModelCache.hostPath | quote }}
    type: Directory
{{- end }}
{{ if .Values.customProfiles -}}
- name: custom-profiles
